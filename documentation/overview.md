...
ASM-NG is a powerful open source intelligence (OSINT) automation platform designed to help security professionals, penetration testers, and threat analysts map attack surfaces, discover external assets, and gather actionable intelligence from hundreds of public data sources.

---

## What is ASM-NG?

ASM-NG automates the process of collecting OSINT by leveraging over 200 modules to gather information about IP addresses, domains, subdomains, emails, usernames, and more. It is suitable for:
...
ASM-NG is designed for both beginners and advanced users, offering a user-friendly web interface as well as a powerful command-line tool for automation and scripting.
...
ASM-NG consists of the following main components:
...
- [Getting Started](getting_started.md): Learn how to install and launch ASM-NG on your platform of choice.
- [Quick Start](quickstart.md): Run your first scan in minutes with step-by-step instructions.
- [User Guide](user_guide.md): Explore advanced features, workflows, and best practices for using ASM-NG effectively.
...
For more information, see the rest of the documentation or visit the [ASM-NG GitHub repository](https://github.com/0x31i/asm-ng).
