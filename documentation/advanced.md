...
Welcome to the advanced section of the ASM-NG documentation. This guide covers topics for power users and administrators who want to optimize, secure, and scale their ASM-NG deployments.

---

## Docker Deployment

ASM-NG can be deployed using Docker for ease of setup, isolation, and scalability. See the [Docker Deployment Guide](../docs/docker_deployment.md) for step-by-step instructions on building, configuring, and running ASM-NG in containers, including tips for persistent storage and networking.

## Performance Optimization

To get the best performance from ASM-NG, consider:
