...
*Maps to: VULNERABILITY_CVE_CRITICAL, VULNERABILITY_CVE_HIGH, VULNERABILITY_CVE_MEDIUM, VULNERABILITY_CVE_LOW, VULNERABILITY_GENERAL*
...
*Maps to: VULNERABILITY_DISCLOSURE*
...
## DOMAIN_NAME
*Maps to: DOMAIN_NAME, DOMAIN_REGISTRAR, DOMAIN_NAME_PARENT, DOMAIN_WHOIS*
...
*Maps to: WEBSERVER_STRANGEHEADER*
...
*Maps to: TARGET_WEB_CONTENT_TYPE*
...
*Maps to: PASSWORD_COMPROMISED, ACCOUNT_EXTERNAL_OWNED_COMPROMISED*
...
*Maps to: ACCOUNT_EXTERNAL_OWNED*
...
*Maps to: INTERESTING_FILE_HISTORIC*
...
*Maps to: SSL_CERTIFICATE_EXPIRING*
...
*Maps to: SSL_CERTIFICATE_MISMATCH*
...
*Maps to: SSL_CERTIFICATE_ISSUED, SSL_CERTIFICATE_ISSUER*
...
## BLACKLISTED_IPADDR
*Maps to: BLACKLISTED_IPADDR, MALICIOUS_IPADDR, BLACKLISTED_SUBNET, MALICIOUS_SUBNET*
...
## STILL MISSING INSTRUCTIONS (not yet mapped)

The following data types do NOT have review instructions yet. The INSTRUCTIONS button will be disabled for these types:
