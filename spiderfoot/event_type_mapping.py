...
EVENT_TYPE_LEGACY_MAPPING = {
    ...
    'AI_MCP_SERVER_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_LLM_VULN_DETECTED': 'VULNERABILITY_DISCLOSURE',
    'AI_PASSIVE_RECON_HIT': 'SOFTWARE_USED',
    'AI_SHADOW_SERVICE_DETECTED': 'SOFTWARE_USED',
    'AI_AGENT_INFRASTRUCTURE_DETECTED': 'VULNERABILITY_DISCLOSURE',
    'AI_AGENT_TOOL_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_VECTORDB_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_RAG_DATA_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_COMPUTE_CLUSTER_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_DATA_PIPELINE_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_TRAINING_DATA_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_MODEL_REGISTRY_EXPOSED': 'VULNERABILITY_DISCLOSURE',
    'AI_VENDOR_WIDGET_DETECTED': 'SOFTWARE_USED',
