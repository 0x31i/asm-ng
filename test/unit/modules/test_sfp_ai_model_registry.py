...
from modules.sfp_ai_model_registry import sfp_ai_model_registry
...
class TestModuleAiModelRegistry(SpiderFootTestBase):

    def test_opts(self):
        module = sfp_ai_model_registry()
    ...
    def test_registry_probes_should_be_list(self):
        module = sfp_ai_model_registry()
        self.assertIsInstance(module.REGISTRY_PROBES, list)
        self.assertGreater(len(module.REGISTRY_PROBES), 0)
        for probe in module.REGISTRY_PROBES:
