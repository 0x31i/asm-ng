...
from modules.sfp_ai_vectordb_scanner import sfp_ai_vectordb_scanner
...
class TestModuleAiVectordbScanner(SpiderFootTestBase):

    def test_opts(self):
        module = sfp_ai_vectordb_scanner()
    ...
    def test_vectordb_probes_should_be_list(self):
        module = sfp_ai_vectordb_scanner()
        self.assertIsInstance(module.VECTORDB_PROBES, list)
        self.assertGreater(len(module.VECTORDB_PROBES), 0)
        for probe in module.VECTORDB_PROBES:
